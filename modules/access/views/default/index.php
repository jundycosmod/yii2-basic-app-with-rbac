    ...
    <div class="col col-lg-10">
        ...
        <p>
            ...
            $form->field($model, 'user_id')->dropDownList(
                    ArrayHelper::map(app\modules\profile\models\Profile::find()->all(), 'user_id', 'name'), ['onchange' => '$(".form-dirty").removeClass("form-dirty"); this.form.action = "'.Yii::$app->urlManager->createUrl('access').'"; this.form.method = "get"; this.form.submit();'
            ])
            ?>
